...
export default function CoursesList(props) {
    ...
    const editCourseModal = (course) => {
        setIsVisibleModal(true);
        setModalTitle('Actualizando nuevo curso');
        setModalContent(
            <AddEditCourseForm
    ...
    const deleteCourse = (course) => {
        ...
        confirm({
            ...
            content: `Estas seguro que quieres elimnar ${course.idCourse}`,
            okText: 'Eliminar',
            okType: 'danger',
            cancelText: 'Cancelar',
            onOk() {
    ...
    return (
        <div className="courses-list">
            <div className="courses-list_header">
                <Button type="primary" onClick={addCourseModal}>
                    Nuevo curso
                </Button>
            </div>
            <div className="courses-list_items">
...
function Course(props) {
    ...
    return (
        ...
        >
            ...
            />
            <List.Item.Meta title={`${courseData.title} | ID: ${course.idCourse}`} description={courseData.headline} />
        </List.Item>
    );
}
