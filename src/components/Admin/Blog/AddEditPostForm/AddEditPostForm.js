...
import { Row, Form, Col, Input, Button, DatePicker, notification } from 'antd';
...
export default function AddEditPostForm(props) {
    ...
    return (
        <div className="add-edit-post-form">
            <AddEditPost postData={postData} setPostData={setPostData} post={post} processPost={processPost} />
        </div>
    );
}
